...
- priority "recommended" → strengthens the package but not required for Phase 1 → set phase1_required: false, fda_tier: "recommended"
...
fda_tier values and meaning:
- "phase1_blocking" — required for IND submission, FDA will reject without it
- "conditional" — required only if a trigger condition fires (e.g. positive hERG → in vivo CV telemetry)
- "recommended" — not required for Phase 1, but makes the package stronger; sponsor may choose to include for most effective development
- "phase2_defer" — not needed before Phase 1; explicitly defer to Phase 2
